...
OUTPUT:\n
""" ->
function felix2jld(; start=" ", stop=" ", outdir=joinpath(@__DIR__, "OUT_felix2jdl"), indir="/home/moon/sfortune/spinevo/newtrees", box="/HydroSims/Magneticum/Box4/uhr_test/", verbose=true)
    # Setup
    ...
    for iii in start:stop
        ...
        try
            ...
            if GadgetGalaxies.total_mass(g.stars.pos, g.stars.mass) > 0.0
                ...
                halo_story["BVAL_0"][1]     = halo_story["BVAL"][1]
            end
        catch
        ...
        save(joinpath(outdir,"$(chop(halofiles[iii], tail=4)).jld"), 
