...
halofiles   = readdir("/home/moon/sfortune/spinevo/newtrees")
...
for ii in 1:length(halofiles)
    ...
    save("/home/moon/sfortune/spinevo/newhalostories/$(chop(halofiles[ii], tail=4)).jld", 
